...
extern const csb_generated_program_t csb_program_min_mysql_capget_missing_0_0;

static const csb_generated_program_t *const csb_programs[] = {
    &csb_program_min_mysql_capget_missing_0_0,
};
...
{
    return "min_mysql_capget_missing_0_0";
}
...
{
    op_name_tbl[0] = "min_mysql_capget_missing_0_0";
