...
//  ]
	res = syscall(__NR_mmap, /*addr=*/0x20361000ul+PTR_OFFSET, /*len=*/0x100000ul, /*prot=PROT_WRITE|PROT_READ*/3ul, /*flags=MAP_FIXED|MAP_ANONYMOUS|MAP_PRIVATE*/0x32ul, /*fd=*/(intptr_t)-1, /*offset=*/0ul);
