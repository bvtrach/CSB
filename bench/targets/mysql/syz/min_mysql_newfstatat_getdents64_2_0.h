...
const static char* UNIQUE_VAR(subdirs)[2] = {"./var/lib/mysql/mysql","var/lib/mysql"};
const static int UNIQUE_VAR(num_filenames) = 1;
const static char* UNIQUE_VAR(filenames)[1] = {"./var/lib/mysql/mysql"};
...
memcpy((void*)(0x203afc00ul+PTR_OFFSET), "./var/lib/mysql/mysql\000", 22);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x203afc00ul+PTR_OFFSET, /*statbuf=*/0x203afc40ul+PTR_OFFSET, /*flag=*/0ul);
...
memcpy((void*)(0x203bd100ul+PTR_OFFSET), "./var/lib/mysql/mysql\000", 22);
	res = syscall(__NR_openat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x203bd100ul+PTR_OFFSET, /*flags=O_NONBLOCK|O_DIRECTORY|O_CLOEXEC*/0x84800, /*mode=S_IXOTH|S_IWOTH|S_IROTH|S_IXGRP|S_IWGRP|S_IRGRP|S_IXUSR|S_IWUSR|0x100*/0x1ff);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
	if (res != -1) {
...
memcpy((void*)(0x203bd200ul+PTR_OFFSET), "./var/lib/mysql/mysql\000", 22);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x203bd200ul+PTR_OFFSET, /*statbuf=*/0x203bd240ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
...
//  ]
	res = syscall(__NR_getdents64, /*fd=*/UNIQUE_VAR(ctx->r)[0], /*ent=*/0x203bd2c0ul+PTR_OFFSET, /*count=*/0x8000ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  getdents64 arguments: [
//    fd: fd_dir (resource)
//    ent: ptr[out, buffer] {
...
//    count: len = 0x8000 (8 bytes)
//  ]
	res = syscall(__NR_getdents64, /*fd=*/UNIQUE_VAR(ctx->r)[0], /*ent=*/0x203bdc00ul+PTR_OFFSET, /*count=*/0x8000ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  close arguments: [
//    fd: fd (resource)
//  ]
...
memcpy((void*)(0x20100cc0ul+PTR_OFFSET), "./var/lib/mysql/mysql\000", 22);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20100cc0ul+PTR_OFFSET, /*statbuf=*/0x20100d00ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
memcpy((void*)(0x20100d80ul+PTR_OFFSET), "./var/lib/mysql/mysql\000", 22);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20100d80ul+PTR_OFFSET, /*statbuf=*/0x20100dc0ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
memcpy((void*)(0x205c1a00ul+PTR_OFFSET), "./var/lib/mysql/mysql\000", 22);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x205c1a00ul+PTR_OFFSET, /*statbuf=*/0x205c1a40ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
memcpy((void*)(0x205c1ac0ul+PTR_OFFSET), "./var/lib/mysql/mysql\000", 22);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x205c1ac0ul+PTR_OFFSET, /*statbuf=*/0x205c1b00ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
	return 0;
}
