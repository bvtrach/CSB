...
//  ]
memcpy((void*)(0x20000080ul+PTR_OFFSET), "./etc/ld.so.preload\000", 20);
	res = syscall(__NR_faccessat, UNIQUE_VAR(ctx->dirfd), /*pathname=*/0x20000080ul+PTR_OFFSET, /*mode=S_IROTH*/4ul);
