...
static inline int bm_dispatch_operation(thread_ctx_t* ctx, size_t op_id)
{
	...
	intptr_t res = 0;
	V_UNUSED(res);
//  prctl$PR_SET_NAME arguments: [
//    option: const = 0xf (8 bytes)
//    name: ptr[in, buffer] {
//      buffer: {63 6f 6e 6e 65 63 74 69 6f 6e 00} (length 0xb)
//    }
//  ]
memcpy((void*)(0x20160a80ul+PTR_OFFSET), "connection\000", 11);
	res = syscall(__NR_prctl, /*option=*/0xful, /*name=*/0x20160a80ul+PTR_OFFSET, 0, 0, 0);
