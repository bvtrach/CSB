...
//    fd: fd_dir (resource)
//    path: ptr[in, buffer] {
//      buffer: {2e 2f 76 61 72 2f 6c 69 62 2f 6d 79 73 71 6c 2f 6d 79 73 71 6c 64 5f 74 6d 70 5f 66 69 6c 65 5f 63 61 73 65 5f 69 6e 73 65 6e 73 69 74 69 76 65 5f 74 65 73 74 2e 4c 4f 57 45 52 2d 54 45 53 54 00} (length 0x41)
//    }
//    flags: unlinkat_flags = 0x0 (8 bytes)
//  ]
memcpy((void*)(0x203b4f40ul+PTR_OFFSET), "./var/lib/mysql/mysqld_tmp_file_case_insensitive_test.LOWER-TEST\000", 65);
	res = syscall(__NR_unlinkat, UNIQUE_VAR(ctx->dirfd), /*path=*/0x203b4f40ul+PTR_OFFSET, /*flags=*/0ul);
...
//  ]
memcpy((void*)(0x20544980ul+PTR_OFFSET), "./var/lib/mysql/mysqld_tmp_file_case_insensitive_test.LOWER-TEST\000", 65);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20544980ul+PTR_OFFSET, /*statbuf=*/0x205449c0ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  unlinkat arguments: [
//    fd: fd_dir (resource)
//    path: ptr[in, buffer] {
...
//    flags: unlinkat_flags = 0x0 (8 bytes)
//  ]
memcpy((void*)(0x20544e00ul+PTR_OFFSET), "./var/lib/mysql/mysqld_tmp_file_case_insensitive_test.LOWER-TEST\000", 65);
	res = syscall(__NR_unlinkat, UNIQUE_VAR(ctx->dirfd), /*path=*/0x20544e00ul+PTR_OFFSET, /*flags=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
//    flag: statx_flags = 0x0 (8 bytes)
//  ]
memcpy((void*)(0x20545040ul+PTR_OFFSET), "./var/lib/mysql/mysqld_tmp_file_case_insensitive_test.LOWER-TEST\000", 65);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20545040ul+PTR_OFFSET, /*statbuf=*/0x20545080ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
	return 0;
}
