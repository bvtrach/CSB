...
memcpy((void*)(0x203b4f40ul+PTR_OFFSET), "./var/lib/mysql/mysqld_tmp_file_case_insensitive_test.LOWER-TEST\000", 65);
	res = syscall(__NR_unlinkat, ctx->dirfd, /*path=*/0x203b4f40ul+PTR_OFFSET, /*flags=*/0ul);
...
memcpy((void*)(0x20544980ul+PTR_OFFSET), "./var/lib/mysql/mysqld_tmp_file_case_insensitive_test.LOWER-TEST\000", 65);
	res = syscall(__NR_newfstatat, ctx->dirfd, /*file=*/0x20544980ul+PTR_OFFSET, /*statbuf=*/0x205449c0ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); ctx->num_failed++;} else {ctx->num_succeeded++;};
//  unlinkat arguments: [
//    fd: fd_dir (resource)
//    path: ptr[in, buffer] {
...
memcpy((void*)(0x20544e00ul+PTR_OFFSET), "./var/lib/mysql/mysqld_tmp_file_case_insensitive_test.LOWER-TEST\000", 65);
	res = syscall(__NR_unlinkat, ctx->dirfd, /*path=*/0x20544e00ul+PTR_OFFSET, /*flags=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); ctx->num_failed++;} else {ctx->num_succeeded++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
memcpy((void*)(0x20545040ul+PTR_OFFSET), "./var/lib/mysql/mysqld_tmp_file_case_insensitive_test.LOWER-TEST\000", 65);
	res = syscall(__NR_newfstatat, ctx->dirfd, /*file=*/0x20545040ul+PTR_OFFSET, /*statbuf=*/0x20545080ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); ctx->num_failed++;} else {ctx->num_succeeded++;};
	return 0;
}
