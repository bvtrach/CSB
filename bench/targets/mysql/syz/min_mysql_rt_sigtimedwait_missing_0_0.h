...
static inline int bm_dispatch_operation(thread_ctx_t* ctx, size_t op_id)
{
	...
	intptr_t res = 0;
	V_UNUSED(res);
//  rt_sigtimedwait arguments: [
//    these: ptr[in, array[intptr]] {
//      array[intptr] {
//        intptr = 0x0 (8 bytes)
//      }
//    }
...
//  ]
*(uint64_t*)(0x200ff480ul+PTR_OFFSET) = 0;
*(uint64_t*)(0x200ff4c0ul+PTR_OFFSET) = 0;
*(uint64_t*)(0x200ff4c8ul+PTR_OFFSET) = 0;
	res = syscall(__NR_rt_sigtimedwait, /*these=*/0x200ff480ul+PTR_OFFSET, /*info=*/0ul, /*ts=*/0x200ff4c0ul+PTR_OFFSET, /*sigsetsize=*/8ul);
