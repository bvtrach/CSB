...
//    }
//  ]
*(uint64_t*)(0x20bfe580ul+PTR_OFFSET) = 1;
*(uint64_t*)(0x20bfe588ul+PTR_OFFSET) = 0;
	res = syscall(__NR_clock_nanosleep, /*id=*/0ul, /*flags=*/0ul, /*rqtp=*/0x20bfe580ul+PTR_OFFSET, /*rmtp=*/0x20bfe5c0ul+PTR_OFFSET);
