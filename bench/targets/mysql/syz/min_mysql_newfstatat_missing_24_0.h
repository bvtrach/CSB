...
memcpy((void*)(0x203b8980ul+PTR_OFFSET), "./var/lib/mysql/ib_buffer_pool\000", 31);
	res = syscall(__NR_newfstatat, ctx->dirfd, /*file=*/0x203b8980ul+PTR_OFFSET, /*statbuf=*/0x203b89c0ul+PTR_OFFSET, /*flag=*/0ul);
...
memcpy((void*)(0x203b8a40ul+PTR_OFFSET), "./var/lib/mysql/ib_buffer_pool\000", 31);
	res = syscall(__NR_newfstatat, ctx->dirfd, /*file=*/0x203b8a40ul+PTR_OFFSET, /*statbuf=*/0x203b8a80ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); ctx->num_failed++;} else {ctx->num_succeeded++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
memcpy((void*)(0x20729e40ul+PTR_OFFSET), "./var/lib/mysql/ib_buffer_pool\000", 31);
	res = syscall(__NR_newfstatat, ctx->dirfd, /*file=*/0x20729e40ul+PTR_OFFSET, /*statbuf=*/0x20729e80ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); ctx->num_failed++;} else {ctx->num_succeeded++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
memcpy((void*)(0x20729f00ul+PTR_OFFSET), "./var/lib/mysql/ib_buffer_pool\000", 31);
	res = syscall(__NR_newfstatat, ctx->dirfd, /*file=*/0x20729f00ul+PTR_OFFSET, /*statbuf=*/0x20729f40ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); ctx->num_failed++;} else {ctx->num_succeeded++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
memcpy((void*)(0x205ca900ul+PTR_OFFSET), "./var/lib/mysql/ib_buffer_pool\000", 31);
	res = syscall(__NR_newfstatat, ctx->dirfd, /*file=*/0x205ca900ul+PTR_OFFSET, /*statbuf=*/0x205ca940ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); ctx->num_failed++;} else {ctx->num_succeeded++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
memcpy((void*)(0x205ca9c0ul+PTR_OFFSET), "./var/lib/mysql/ib_buffer_pool\000", 31);
	res = syscall(__NR_newfstatat, ctx->dirfd, /*file=*/0x205ca9c0ul+PTR_OFFSET, /*statbuf=*/0x205caa00ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); ctx->num_failed++;} else {ctx->num_succeeded++;};
	return 0;
}
