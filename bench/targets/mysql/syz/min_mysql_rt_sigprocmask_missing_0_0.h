...
//    how: sigprocmask_how = 0x2 (8 bytes)
//    nset: ptr[in, array[intptr]] {
//      array[intptr] {
//        intptr = 0x0 (8 bytes)
//      }
//    }
...
//  ]
*(uint64_t*)(0x20160a40ul+PTR_OFFSET) = 0;
	res = syscall(__NR_rt_sigprocmask, /*how=SIG_SETMASK*/2ul, /*nset=*/0x20160a40ul+PTR_OFFSET, /*oset=*/0ul, /*sigsetsize=*/8ul);
