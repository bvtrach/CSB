...
//  ]
*(uint32_t*)(0x206073c0ul+PTR_OFFSET) = 0;
	res = syscall(__NR_futex, /*addr=*/0x206073c0ul+PTR_OFFSET, /*op=FUTEX_PRIVATE_FLAG|FUTEX_WAKE*/0x81ul, /*val=*/1, /*timeout=*/0ul, /*addr2=*/0ul, /*val3=*/0);
