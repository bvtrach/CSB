...
memcpy((void*)(0x208b7ec0ul+PTR_OFFSET), "private_key.pem\000", 16);
	res = syscall(__NR_faccessat, UNIQUE_VAR(ctx->dirfd), /*pathname=*/0x208b7ec0ul+PTR_OFFSET, /*mode=*/0ul);
...
memcpy((void*)(0x208b9000ul+PTR_OFFSET), "private_key.pem\000", 16);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x208b9000ul+PTR_OFFSET, /*statbuf=*/0x208b9040ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  newfstatat arguments: [
//    dfd: const = 0xffffffffffffff9c (8 bytes)
//    file: ptr[in, buffer] {
...
memcpy((void*)(0x208b9140ul+PTR_OFFSET), "private_key.pem\000", 16);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x208b9140ul+PTR_OFFSET, /*statbuf=*/0x208b9180ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
	return 0;
}
