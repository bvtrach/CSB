...
const static char* UNIQUE_VAR(subdirs)[1] = {"#clone"};
const static int UNIQUE_VAR(num_filenames) = 1;
const static char* UNIQUE_VAR(filenames)[1] = {"#clone/#old_files"};
...
memcpy((void*)(0x203af540ul+PTR_OFFSET), "#clone/#old_files\000", 18);
	res = syscall(__NR_openat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x203af540ul+PTR_OFFSET, /*flags=O_NONBLOCK|O_CREAT*/0x840, /*mode=S_IXOTH|S_IWOTH|S_IROTH|S_IXGRP|S_IWGRP|S_IRGRP|S_IXUSR|S_IWUSR|0x100*/0x1ff);
...
memcpy((void*)(0x203af580ul+PTR_OFFSET), "#clone/#old_files\000", 18);
	res = syscall(__NR_openat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x203af580ul+PTR_OFFSET, /*flags=O_NONBLOCK|O_CREAT*/0x840, /*mode=S_IXOTH|S_IWOTH|S_IROTH|S_IXGRP|S_IWGRP|S_IRGRP|S_IXUSR|S_IWUSR|0x100*/0x1ff);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
//  openat arguments: [
//    fd: fd_dir (resource)
//    file: ptr[in, buffer] {
...
memcpy((void*)(0x207d12c0ul+PTR_OFFSET), "#clone/#old_files\000", 18);
	res = syscall(__NR_openat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x207d12c0ul+PTR_OFFSET, /*flags=O_NONBLOCK|O_CREAT*/0x840, /*mode=S_IXOTH|S_IWOTH|S_IROTH|S_IXGRP|S_IWGRP|S_IRGRP|S_IXUSR|S_IWUSR|0x100*/0x1ff);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
	return 0;
}
