...
//    rmtp: nil
//  ]
*(uint64_t*)(0x200ff900ul+PTR_OFFSET) = 1;
*(uint64_t*)(0x200ff908ul+PTR_OFFSET) = 0;
	res = syscall(__NR_clock_nanosleep, /*id=*/0ul, /*flags=*/0ul, /*rqtp=*/0x200ff900ul+PTR_OFFSET, /*rmtp=*/0ul);
