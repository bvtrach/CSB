...
//    file: ptr[in, buffer] {
//      buffer: {2f 70 72 6f 63 2f 6d 65 6d 69 6e 66 6f 00} (length 0xe)
//    }
//    flags: const = 0x0 (4 bytes)
//    mode: const = 0x0 (2 bytes)
//  ]
//  returns fd
memcpy((void*)(0x201041c0ul+PTR_OFFSET), "/proc/meminfo\000", 14);
	res = syscall(__NR_openat, ctx->dirfd, /*file=*/0x201041c0ul+PTR_OFFSET, /*flags=*/0x800, /*mode=*/0);
...
//  ]
	res = syscall(__NR_read, /*fd=*/ctx->r[0], /*buf=*/0x20104200ul+PTR_OFFSET, /*count=*/0x1ffful);
	if (res == -1 ) { assert(!abort_on_fail); ctx->num_failed++;} else {ctx->num_succeeded++;};
//  close arguments: [
//    fd: fd (resource)
//  ]
