...
memcpy((void*)(0x20c1d480ul+PTR_OFFSET), ".//ib_buffer_pool\000", 18);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20c1d480ul+PTR_OFFSET, /*statbuf=*/0x20c1d4c0ul+PTR_OFFSET, /*flag=*/0ul);
...
memcpy((void*)(0x20cc4e00ul+PTR_OFFSET), ".//ib_buffer_pool\000", 18);
	res = syscall(__NR_newfstatat, UNIQUE_VAR(ctx->dirfd), /*file=*/0x20cc4e00ul+PTR_OFFSET, /*statbuf=*/0x20cc4e40ul+PTR_OFFSET, /*flag=*/0ul);
	if (res == -1 ) { assert(!abort_on_fail); UNIQUE_VAR(ctx->num_failed)++;} else {UNIQUE_VAR(ctx->num_succeeded)++;};
	return 0;
}
